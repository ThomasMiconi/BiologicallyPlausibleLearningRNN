...
# This one is to be used for the EI network with nonnegative responses, where the target responses are 0 and 5. Therefore, we modify the criterion so that it is now error < 2.5 (rather than 1)
...
patts = glob.glob('errs_G1.500000_MAXDW0.000100_ETA0.000030_ALPHAMODUL16.000000_PROBAMODUL0.003000_SQUARING1_MODULTYPE-DECOUPLED_ALPHATRACE0.750000_METHOD-DELTAX_ATRACEEXC0.050000_TAU30.000000_RNGSEED8.txt')
#errs*SEED8.txt')
#// errs_G.500000_MAXDW0.000300_ETA0.010000_ALPHAMODUL16.000000_PROBAMODUL0.003000_SQUARING1_MODULTYPE-DECOUPLED_ALPHATRACE0.750000_METHOD-DELTAX_ATRACEEXC0.050000_TAU30.000000_RNGSE*
...
for selectstr in selectstrs:
    ...
    if 1:
        ...
        for nm in fnames:
            ...
            correctz = np.uint8(eee<2.5)   #  Modified criterion: (absolute) error < 2.5
...
plt.title('E-I network')
plt.draw()
plt.savefig('figure_errs_EI.png', bbox_inches='tight', dpi=300)
